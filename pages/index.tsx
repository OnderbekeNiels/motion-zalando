...
import clothesXCarousel from '../lotties/clothesXCarousel.json';
import clothesScroll from '../lotties/clothesScroll.json';
      ...
      <main>
        ...
        <Section className='o-section--md'>
          ...
          <Row className='u-bg-color-accents--yellow-250'>
              ...
              <Card title='Nieuw kledingstijl ? Help! ' description='Scroll door vele verschillende stijlen en vindt de look die bij jou past! Zalando sorteert ze alvast voor jou.' animation={clothesScroll} />
